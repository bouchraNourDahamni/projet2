...
export class ChangeFillColorOperation implements AbstractOperation {
  ...
  public undo(): void {
    this.changeColorService.changeColor(this.target, this.colors.oldColor, this.colors.oldOpacity);
  }

  public redo(): void {
    this.changeColorService.changeColor(this.target, this.colors.newColor, this.colors.newOpacity);
  }
}
